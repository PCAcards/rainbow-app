...
function App() {
  ...
  return (
    <s.Screen style={{ backgroundImage: 'url(/public/bg000.png', overflowY:"scroll", backgroundSize: 'cover' }} >
    {/* HOME PAGE SECTION */}
      ...
      <s.Container flex={2} jc={"center"} ai={"center"} > 
        ...
        <s.SpacerSmall />
        <StyledImg alt={"slabs"} src={"/public/config/images/slabs.gif"} />
        <s.SpacerLarge />

        <s.Container fd={"row"} jc={"center"} ai={"center"}>
          <CoinImg alt={"Coin"} src={"/public/config/images/coin.png"} />
    ...
    <a id="ABOUT"></a>
      ...
      <s.Container ai={"center"} jc={"center"}>
        <s.SpacerSmall />
        <StyledImgWide alt={"all10"} src={"/public/config/images/all10.png"} />
      </s.Container>
      <s.SpacerLarge />
      ...
      <s.SpacerSmall />
      <s.Container ai={"center"} jc={"center"}>
        <StyledImg alt={"mystery"} src={"/public/config/images/mystery.png"} />
      </s.Container>
      <s.SpacerSmall />
      <s.Container fd={"row"} ai={"flex-start"} jc={"flex-start"}>
        <CoinImg alt={"Coin"} src={"/public/config/images/coin.png"}/>
    ...
    <a id="MINTING"></a>
      ...
      <s.Container ai={"center"} jc={"center"}>
        <img alt={"rainbow3"} src={"/public/config/images/rainbow3.png"} width = "60%" />
      </s.Container>
